...
<table border="1">
    <tr>
        <td colspan="7">
            ...
            <label style="margin-left: 80%">%;"><?php echo"Date:".date("d-m-Y");?></label>
            <center>
            ...
            <label >Customer Name</label><input type="text" name="cust">
            <label style="margin-left: 50%%;">Doctor Name</label><input type="text" name="Doct">
        </center>
